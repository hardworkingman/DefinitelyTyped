...
interface Messager {
  ...
  primary(message: string, option?: MessagerOption): Messager;
  danger(message: string, option?: MessagerOption): Messager;
  success(message: string, option?: MessagerOption): Messager;
  info(message: string, option?: MessagerOption): Messager;
  warning(message: string, option?: MessagerOption): Messager;
  important(message: string, option?: MessagerOption): Messager;
  special(message: string, option?: MessagerOption): Messager;
}
